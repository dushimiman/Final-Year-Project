        ...
        <div class="app-main">
                ...
                <div class="app-main__outer">
                    ...
                    <div class="app-main__inner">
                        <div class="row">
                            <?php echo"<h5 style='margin-left: 15px; margin-bottom: 20px;'>Hello ".$d_u['fullname']."!</h5>"; ?>
                                ...
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        ...
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span><?php echo $d_u['balance']; ?> Frw</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tbody>
                                            <?php
                                                $sql_u = mysqli_query($connect, "SELECT * FROM transactions WHERE account = '$accountNo' ORDER BY id DESC LIMIT 5");
