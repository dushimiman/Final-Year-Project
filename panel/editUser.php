                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    ...
                                    if(isset($_GET['data'])){
                                        if($_GET['data'] == 'edited'){
                                            echo"<div class='alert alert-success' style='padding: 7px 20px; border-radius: 0;'>Teller is edited successfully!</div>";
                                        }
                                    }
                                    ?>
                                    <div style="padding: 10px 20px 30px 20px;">
                                        <?php
                                            $sql_u = mysqli_query($connect, "SELECT * FROM users WHERE userid = '".$_GET['userId']."'");
                                            $d_u = mysqli_fetch_array($sql_u);
                                            echo"<form method='POST' action='../server.php'>
                                                <input type='hidden' name='userid' value='".$d_u['userid']."'>
                                                ...
                                                <div class='form-group'>
                                                    ...
                                                    <input type='email' value='".$d_u['email']."' name='email' class='form-control' placeholder='Email' required>
                                                </div>
