                                ...
                                <div class="main-card mb-3 card">
                                    ...
                                    <div style="padding: 10px 20px 30px 20px;">
                                        <?php
                                            if(isset($_GET['data'])){
                                                if($_GET['data'] == 'anv'){
                                                    echo"<div class='alert alert-warning' style='padding: 7px 20px; border-radius: 0;'>Amount should be a valid number!</div>";
                                                }
                                                if($_GET['data'] == 'adis'){
                                                    echo"<div class='alert alert-warning' style='padding: 7px 20px; border-radius: 0;'>Account is disabled!</div>";
                                                }
                                            }
                                        ?>
                                        <form method="POST" action="../server.php">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="account" class="form-control" placeholder="Account" required onkeypress="return allowNumbersOnly(event)">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="amount" class="form-control" placeholder="Amount" required onkeypress="return allowNumbersOnly(event)">
                                            </div>
                                            <button type="submit" name="addNewTransaction" class="btn btn-primary">Add new</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
